...
public class zTest4_3 extends uApp {

	// PROBLEM -
	// Property reading itself as source upon ListenerUpdate message
	PerspectiveCamera p;
	public ObserverKernel Environment;
	...
	public void create() {
		...
		this.Explorer.init();
		this.Environment = new ObserverKernel(this.Explorer.perspective.camera, new Vector3(24, 24, 24), 1024 * 10);
