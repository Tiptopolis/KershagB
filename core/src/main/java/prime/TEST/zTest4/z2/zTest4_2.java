...
public class zTest4_2 extends uApp {
	...
	public void create() {
		...
		this.Explorer.init();
		 ...
		 this.ExplorerRenderer = new ObsRenderer(this.ExplorerKernel);
	...
	public void update(float deltaTime) {
		...
		//Log(this.ExplorerKernel.toDraw.size + "  <<");
	}
	...
	public void render() {
		...
		Sketcher.setProjectionMatrix(new Matrix4().setToOrtho2D(0, 0, Width, Height));
		this.ExplorerRenderer.render();
	}

	@Override
	public void dispose() {
		super.dispose();
		this.ExplorerKernel.dispose();
	}
