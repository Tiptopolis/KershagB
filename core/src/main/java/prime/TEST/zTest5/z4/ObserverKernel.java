...
public class ObserverKernel {
				...
				synchronized (this.dstSorted) {
					...
					for (int i = 0; i < Members.size; i++) {
						...
						if (e instanceof zEnt) {
							...
							// E.position(E.position().cpy().add(moveby.scl(0.001f)),true);

							Vector3 r = VectorUtils.downcast(E.rotation());
							r.add(moveby.scl(0.001f));
							E.transform.SetRotation(VectorUtils.upcast(r));
	...
	private static void applyRandomTrns(zEnt E) {
